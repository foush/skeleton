 ...
 */
class Company extends \Application\Entity\Base\Company implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'address', 'contact', 'active', 'id', 'dateFormatFlat');
        }
