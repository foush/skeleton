angular.module('fzyskeleton').controller('EditCtrl', ["$scope", "Restangular", "editService", "alert", "formAlert", "select2Role", function($scope, Restangular, editService, alert, formAlert, select2Role) {
