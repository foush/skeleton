...
class User extends Entity implements UserInterface
{
    ...
    {
        return $this->nullGet('Application\Entity\Base\User\Role', $this->role);
    }
    ...
    {
	    if (count($roles) > 1) {
		    throw new \RuntimeException("Multi-role users not supported at this time");
	    }
	    $role = reset($roles);
	    $this->setRole($role);
	    return $this;
    ...
    {
        $this->role = $role->asDoctrineProperty();
