...
use Application\Exception\Annotation\DuplicateName;
use Application\Exception\Annotation\NoSuchChild;
...
class Element
{
    ...
    const DEFAULT_TEMPLATE = 'partials/form/element.phtml';
    ...
    /**
     * @var \Application\Annotation\Form
     */
    ...
    /**
     * @param  \Application\Annotation\Form $parentForm
     * @return Element
     */
    public function setParentForm(\Application\Annotation\Form $parentForm)
    {
    ...
    /**
     * @return \Application\Annotation\Form
     */
